...
- [OS-Elephant学习笔记](#os-elephant学习笔记)
	- [参考书目 : 操作系统真象还原](#参考书目-操作系统真象还原)
	- [repository目录介绍](#repository目录介绍)
	- [GitBook地址](#gitbook地址)
	- [我的任务](#我的任务)
	- [visio图示](#visio图示)
	- [《操作系统真象还原》作者](#操作系统真象还原作者)
	- [《一个中专生的奋斗，只为不负时光》](#一个中专生的奋斗只为不负时光)
	- [半平米的梦想 ——《操作系统真象还原》背后的故事](#半平米的梦想-操作系统真象还原背后的故事)
...
![1526720522620.png](image/1526720522620.png)
